namespace FlowPilot.Host.FlowPilot.Host.Configurations
{
    internal static class Startup
    {
        internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
        {
            ...
            builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                    ...
                    .AddJsonFile($"{configurationsDirectory}/externalIntegrations.json", optional: false, reloadOnChange: true)
                    .AddJsonFile($"{configurationsDirectory}/externalIntegrations.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
                    ...
                    .AddJsonFile($"{configurationsDirectory}/fileStorage.json", optional: false, reloadOnChange: true)
                    .AddJsonFile($"{configurationsDirectory}/fileStorage.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
