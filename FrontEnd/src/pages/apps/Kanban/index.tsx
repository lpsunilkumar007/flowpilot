						...
						<form onSubmit={handleSubmit(handleNewTask)}>
							...
							<div className="grid sm:grid-cols-2 gap-6">
								<div className="col-md-6">
									<FormInput name="assignTo" label="Assign To" type="select" containerClass="space-y-1.5 mb-6" labelClassName="form-label" className="form-select" key="assignTo" register={register} errors={errors} control={control}>
