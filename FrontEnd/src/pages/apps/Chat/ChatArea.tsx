						...
						<div className="bg-light p-6 dark:bg-gray-700">
							<form name="chat-form" noValidate onSubmit={handleSubmit(sendChatMessage)}>
								<div className="flex gap-2">
									<FormInput type="text" name="newMessage" containerClass="w-full" className="form-input border-none bg-white dark:bg-gray-800 placeholder:text-slate-400" placeholder="Enter your text" register={register} key="newMessage" errors={errors} control={control as any} />
									<div className="w-auto">
