		...
		<>
			<AuthLayout2 pageImage="/images/users/avatar-1.jpg" title="Hi ! Tosha" helpText="Enter your password to access the admin." starterClass hasThirdPartyLogin bottomLinks={<BottomLink />}>
				<VerticalForm onSubmit={() => null}>
					<FormInput label={'Password'} labelClassName="form-label" className="form-input rounded-e-none" type="password" name="password" placeholder={'Enter your password'} containerClass={'mb-6 space-y-2'} labelContainerClassName="text-start" />
