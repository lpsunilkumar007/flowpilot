	...
	return (
		<>
			<AuthLayout2 title="Sign In" helpText="Enter your email address and password to access account." hasThirdPartyLogin bottomLinks={<BottomLink />}>
				<VerticalForm onSubmit={onSubmit} resolver={schemaResolver} defaultValues={{ username: 'admin@root.com', password: '123Pa$$word!' }}>
					<FormInput label="Email address" labelClassName="form-label" type="email" className="form-input" name="username" placeholder={'Enter your email'} containerClass="mb-6 space-y-2" />
