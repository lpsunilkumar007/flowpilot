		...
		<>
			<AuthLayout2 title="Free Sign Up" helpText="EnDon't have an account? Create your account, it takes less than a minute" bottomLinks={<BottomLink />} hasThirdPartyLogin>
				<VerticalForm onSubmit={() => null}>
					<FormInput label="Full Name" type="text" labelClassName="form-label" name="fullname" className="form-input" placeholder={'Enter your Name'} containerClass={'mb-6 space-y-2'} />

					<FormInput label="Email address" type="email" name="email" className="form-input" labelClassName="form-label" placeholder={'Enter your email'} containerClass={'mb-6 space-y-2'} />
					<FormInput label={'Password'} type="password" name="password" labelClassName="form-label" className="form-input rounded-e-none" placeholder={'Enter your password'} containerClass={'mb-6 space-y-2'} labelContainerClassName="flex justify-between items-center mb-2">
