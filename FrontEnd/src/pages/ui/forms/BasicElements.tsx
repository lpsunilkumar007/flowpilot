		...
		<div className="card mb-6">
			<div className="p-6">
				...
				<div className="grid lg:grid-cols-2 gap-6">
					<div>
						<form>
							<FormInput label="Text" labelClassName="form-label" type="text" name="text" className="form-input" containerClass="form-field" register={register} key="text" errors={errors} control={control} />

							<FormInput label="Email" labelClassName="form-label" type="email" name="email" placeholder="Email" className="form-input" containerClass="form-field" register={register} key="email" errors={errors} control={control} />
							<FormInput label="Password" labelClassName="form-label" type="password" name="password" containerClass="form-field" className="form-input" register={register} key="password" errors={errors} control={control} />

							<FormInput label="Placeholder" labelClassName="form-label" type="text" containerClass="form-field" name="placeholder" placeholder="placeholder" className="form-input" register={register} key="placeholder" errors={errors} control={control} />

							<FormInput label="Text area" type="textarea" name="textarea" id="textarea" containerClass="form-field" labelClassName="form-label" rows={5} register={register} className="form-input" key="textarea" errors={errors} control={control} />

							<FormInput label="Readonly" type="text" name="text1" id="text1" placeholder="Readonly value" readOnly containerClass="form-field" labelClassName="form-label" register={register} className="form-input" key="text1" errors={errors} control={control} />

							<FormInput label="Disabled" type="text" name="text2" id="text2" placeholder="Disabled value" disabled className="form-input" containerClass="form-field" labelClassName="form-label" register={register} key="text2" errors={errors} control={control} />

							<FormInput label="Helping Text" type="text" name="helpText" id="helpingText" placeholder="Helping value" className="form-input" labelClassName="form-label" register={register} key="helpText" errors={errors} control={control} />
							<div className="help-block mb-3">
								<small>A block of help text that breaks onto a new line and may extend beyond one line.</small>
							</div>

							<FormInput name="select" label="Input Select" type="select" containerClass="form-field" labelClassName="form-label" className="form-select" register={register} key="select" errors={errors} control={control}>
					...
					<div>
						<form onSubmit={() => handleSubmit}>
							<FormInput name="selectMulti" label="Multiple Select" type="select" multiple labelClassName="form-label" containerClass="form-field" className="form-select" register={register} key="selectMulti" errors={errors} control={control}>
								<option defaultValue="selected">1</option>
								<option>2</option>
								<option>3</option>
								<option>4</option>
							...
							<FormInput label="Default file input" type="file" name="file" labelClassName="form-label" containerClass="form-field" className="form-input border" register={register} key="file" errors={errors} control={control} />

							<FormInput label="Date" type="date" name="date" containerClass="form-field" labelClassName="form-label" className="form-input" register={register} key="date" errors={errors} control={control} />

							<FormInput label="Month" type="month" name="month" containerClass="form-field" labelClassName="form-label" className="form-input" register={register} key="month" errors={errors} control={control} />

							<FormInput label="Time" type="time" name="time" containerClass="form-field" labelClassName="form-label" className="form-input" register={register} key="time" errors={errors} control={control} />

							<FormInput label="Week" type="week" name="week" labelClassName="form-label" containerClass="form-field" className="form-input" register={register} key="week" errors={errors} control={control} />

							<FormInput label="Number" type="number" name="number" containerClass="form-field" labelClassName="form-label" className="form-input" register={register} key="number" errors={errors} control={control} />

							<FormInput label="Color" type="color" name="color" labelClassName="form-label" containerClass="form-field" className="form-input h-12" register={register} key="color" errors={errors} control={control} />
							<FormInput label="Range" type="range" name="range" labelClassName="form-label" containerClass="mt-5" className="form-range mt-2" register={register} key="Range" errors={errors} control={control} />
						</form>
					</div>
				</div>
			</div>
	...
	return (
		<div className="card">
			<div className="p-6">
				...
				<form>
					<FormInput label="Small" type="text" name="small" id="small1" className="form-input form-input-sm" labelClassName="form-label" containerClass="form-field" placeholder=".input-sm" />

					<FormInput label="Normal (Default)" type="text" name="normal" id="normal" className="form-input" labelClassName="form-label" containerClass="form-field" placeholder="Normal" />

					<FormInput label="Large" type="text" name="large" id="large" className="form-input form-input-lg" placeholder=".form-input-sm" labelClassName="form-label" containerClass="form-field" />
				</form>
			</div>
		</div>
	)
