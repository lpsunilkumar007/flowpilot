			...
			<div className="p-6">
				...
				<div className="pt-5">
					<form onSubmit={(e) => e.preventDefault()}>
						<div className="mb-3">
							<FormInput label="Email address" labelClassName="form-label" type="email" name="email" placeholder="Enter email" className="form-input" key="email" />
							<small id="emailHelp" className="form-text text-sm text-slate-700 dark:text-slate-400">
								We'll never share your email with anyone else.
							</small>
						</div>
						<FormInput label="Password" labelClassName="form-label" containerClass="form-field" type="password" name="password1" placeholder="Password" className="form-input" key="password1" />
					...
					<div className="pt-5">
						...
						<form onSubmit={(e) => e.preventDefault()}>
							<div className="grid grid-cols-1 md:grid-cols-2  gap-6">
								<FormInput label="Email" labelClassName="form-label" type="email" name="email3" className="form-input" placeholder="Email" key="email3" />
								<FormInput label="Password" labelClassName="form-label" type="password" name="password4" placeholder="Password" className="form-input" key="password4" />

								<FormInput label="Address" containerClass="lg:col-span-2" labelClassName="form-label" type="text" name="address" className="form-input" placeholder="1234 Main St" key="address" />

								<FormInput label="Address 2" labelClassName="form-label" type="text" name="address2" className="form-input" placeholder="Apartment, studio, or floor" key="address2" />

								<FormInput label="City" labelClassName="form-label" type="text" name="city" className="form-input" key="city" />
								<FormInput label="State" name="select" type="select" className="form-select" labelClassName="form-label">
								...
								<FormInput label="Zip" labelClassName="form-label" type="text" name="zip" className="form-input" key="zip" />
							</div>
