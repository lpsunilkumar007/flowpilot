				...
				<div className="p-6">
					...
					<div className="pt-5">
						<form className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6">
							<FormInput name="FirstName" type="text" label="First name" labelClassName="form-label" className="form-input" key="first-Name" placeholder="Mark" required />
							<FormInput name="LastName" type="text" label="Last name" labelClassName="form-label" className="form-input" key="last-Name" placeholder="Otto" required />
							...
							<FormInput name="City" type="text" label="City" labelClassName="form-label" className="form-input" key="city" required />

							<FormInput name="State" type="select" label="State" labelClassName="form-label" className="form-input" key="state">
							...
							<FormInput name="Zip" type="text" label="Zip" labelClassName="form-label" className="form-input" key="zip" required />
