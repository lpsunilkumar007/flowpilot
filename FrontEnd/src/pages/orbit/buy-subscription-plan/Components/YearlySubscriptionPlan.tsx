...
const YearlyPlans: React.FC<PlanProps> = (props) => {
	...
	const handlePurchase = async (plan: GetSubscriptionPlanDetailsResponse) => {
		props.onActionClick(plan, 'YearlyPlanSelected')
	}
	return (
					...
					>
						...
						<div className="mb-6">
							...
							<div className="mt-6 flex items-baseline">
								...
								<span className="orbit-plan-price-suffix">/yr</span>
							</div>
							<div className="mt-2 text-sm orbit-muted leading-relaxed">
								Valid for <span className="font-semibold">{plan.validityDuration}</span> year
							</div>
