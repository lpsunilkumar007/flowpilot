...
const DynamicLoaded = () => {
	useEffect(() => {
		...
		const chart = new ApexCharts(document.querySelector('#chart-year') as HTMLElement, options)
		chart.render()

		const optionsQuarter: ApexOptions = {
			series: [
				{
					data: [],
				},
		...
		const chartQuarter = new ApexCharts(document.querySelector('#chart-quarter') as HTMLElement, optionsQuarter)
		chartQuarter.render()
