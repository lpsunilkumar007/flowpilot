...
const RegisterSuccess = () => {
	return (
		<>
			...
			<AuthContainer>
				<AuthLayout hasForm={false} bottomLinks={<BottomLink />} pageImage={mail} helpText="A email has been send to your email. Please check for an email from company and click on the included link to reset your password." authTitle="Please check your email">
					<Link to="/">
						<div className="text-center mb-6">
							<button className="btn bg-primary text-white" type="submit">
								<i className="ri-home-4-line me-1.5"></i> Back To Login{' '}
							</button>
						</div>
					</Link>
				</AuthLayout>
