...
const RecoverPassword = () => {
	...
	const onSubmit = (formData: UserData) => {
		dispatch(forgotPassword(formData.username)as any)
	}
	return (
		<>
				...
				<AuthLayout authTitle="Reset Password" helpText="Enter your email address and we'll send you an email with instructions to reset your password." bottomLinks={<BottomLink />}>
					{!passwordReset && (
						<VerticalForm<UserData> onSubmit={onSubmit} resolver={schemaResolver}>
							<FormInput label="Email address" type="text" name="username" placeholder="Enter your email" labelClassName="form-label-auth" containerClass="form-field-auth" className="form-input" required />
