...
export enum MenuLinks {
	...
	CreateCampaign = '/manage-campaigns/create',
	ViewCampaign = '/manage-campaigns/:id',
...
const MENU_ITEMS: MenuItemTypes[] = [
	...
	},
	{
		...
		label: 'Manage.Campaigns_Heading',
		isTitle: false,
		icon: 'ri-mail-send-line',
		url: MenuLinks.ManageCampaigns,
	},
	{
		key: 'sales_pipeline',
...
const getMenuItems = () => {
	...
	const permissionMapping: Record<string, PermissionTypes[]> = {
		sales_crm: [
			...
			PermissionTypes.Permissions_ManageCampaigns_View,
		...
		manage_campaigns: [PermissionTypes.Permissions_ManageCampaigns_View],
