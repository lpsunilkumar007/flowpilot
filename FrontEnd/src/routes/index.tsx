...
// route modules
import { authRoutes, otherPublicRoutes } from './authRoutes'
import { orbitRoutes } from './orbitRoutes'
import { dashboardRoutes } from './dashboardRoutes'
import { appsRoutes } from './appsRoutes'
import { flattenRoutes, type RoutesProps } from './utils'

export type { RoutesProps } from './utils'
...
// All routes
const authProtectedRoutes = [dashboardRoutes, ...appsRoutes, ...orbitRoutes, customPagesRoutes, uiRoutes]
